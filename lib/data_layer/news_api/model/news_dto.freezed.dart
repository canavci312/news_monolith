...
class _$_NewsDTO implements _NewsDTO {
  ...
  @override
  String toString() {
    return 'NewsDTO(source: $source, author: $author, title: $title, description: $description, url: $url, urlToImage: $urlToImage, publishedAt: $publishedAt, content: $content)';
  }
...
abstract class _NewsDTO implements NewsDTO {
  const factory _NewsDTO(
      ...
      final String? urlToImage,
      final String? publishedAt,
      final String? content}) = _$_NewsDTO;
